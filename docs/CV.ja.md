...
- 2024.11, [MIMS現象数理学拠点オンラインチュートリアルシリーズ, Pythonによるデータ解析と数値計算](https://sites.google.com/view/mims-python2024/)
- 2024.1, [MIMS現象数理学拠点オンラインチュートリアルシリーズ, Pythonによるデータ解析と数値計算](https://sites.google.com/view/mimstutorial2023/)
- 2022.12, [MIMS現象数理学拠点オンラインチュートリアルシリーズ, Pythonによるデータ解析と数値計算](https://sites.google.com/view/mimspython2022/)
- 2021.9, [MIMS現象数理学拠点オンラインチュートリアルシリーズ, Pythonによるデータ解析と数値計算](https://sites.google.com/view/mimspython2021/)
- 2020.9, [MIMS現象数理学拠点オンラインチュートリアルシリーズ, Pythonによるデータ解析と数値計算](https://sites.google.com/view/mimspython/)
...
* [Google Scholoar](https://scholar.google.com/citations?user=ee6FzccAAAAJ&hl=ja)
* [ReserchGate](https://www.researchgate.net/profile/Masashi-Shiraishi)
* [Individual Page on Department Site](https://is.info.hiroshima-cu.ac.jp/staff/286/)